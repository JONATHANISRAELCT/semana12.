...
matriz_factura = []
matriz_factura.append(calculo_valor_item(producto="correas", cantidad=2, precio_unitario=1.75))
matriz_factura.append(calculo_valor_item(producto="porta arma", cantidad=3, precio_unitario=5))
matriz_factura.append(calculo_valor_item(producto="casco", cantidad=4, precio_unitario=25))
